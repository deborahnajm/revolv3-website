...
export const hero = {
  ...
  titleLead: 'Your processors optimize for their network.',
  titleEmph: 'We optimize for your revenue.',
  sub: 'There is a difference. Revolv3 is the control and optimization layer that sits above your processors — improving approvals, recovering revenue, and turning authorization from an accepted variable into a managed outcome. We will show you what the gap is worth.',
...
export const problem = {
  ...
  body: 'It is a fact about the tools you use to measure it — and about what those tools are designed to show you. When your only performance data comes from your processor, you are asking the entity you are trying to evaluate to evaluate itself.',
  points: [
    {
      icon: 'eye-off',
    ...
    {
      icon: 'line-chart',
      title: 'Performance is graded by the graded',
      body: 'The tools you use to measure payment performance were built by the parties whose business does not depend on improving it.',
    },
    {
      icon: 'git-branch',
...
export const impact = {
  ...
  stats: [
    ...
    { value: 30, prefix: '$', suffix: 'K–$100K', label: 'Per day lost to declined installment charges at one merchant, before Revolv3' },
  ],
}
  ...
  rows: [
    {
      ...
      themDesc: 'Optimize within one network. Incentivized to retain, not to benchmark honestly.',
...
export const story = {
  ...
  quote: 'The parties best positioned to show merchants what they are losing have no financial incentive to do so. Someone needed to build the layer that did.',
}
...
export const voc = [
  ...
  { quote: 'It just does not make any sense.', ctx: 'On a 300 bps swing routing Chase through Chase vs. another processor' },
